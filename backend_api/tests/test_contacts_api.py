...
class InvoiceAPITestCase(APITestCase):
    def setUp(self):
        ...
        self.contact = Contact.objects.create(user=self.user, name="John Doe")
    ...
    def test_invoice_create_api(self):
        payload = {
            ...
            "invoice_type": "default",
            "supply_type": "regular",
            "items": [{"description": "A", "quantity": 2, "rate": 100, "discount": 0}],
        }
    ...
    def test_invoice_list_only_user_data(self):
        ...
        Invoice.objects.create(
            user=self.other_user, contact=contact2, invoice_type="default"
        )
    ...
    def test_invoice_update_api(self):
        payload = {
            "items": [{"description": "X", "quantity": 5, "rate": 100, "discount": 0}]
        }
