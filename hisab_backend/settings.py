"""
Django settings for hisab_backend project.
...
# SECRET_KEY = 'django-insecure-=jm_6r87)#x6muye0jjn#^mqyg$z_5(=4+0&0z26w6q8ipchm2'
...
ROOT_URLCONF = 'hisab_backend.urls'
...
WSGI_APPLICATION = 'hisab_backend.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'backend_api.utils.custom_exception_handler.custom_exception_handler',
}
